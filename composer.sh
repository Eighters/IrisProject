...
/bin/bash -l -c cd php bin/console cache:clear --env=prod

/bin/bash -l -c cd php bin/console doctrine:database:create

/bin/bash -l -c cd php bin/console doctrine:schema:update --dump-sql

/bin/bash -l -c cd php bin/console doctrine:schema:update --force
